...
This is the compact v2 training run for the response-style-control experiment.
It trains a LoRA adapter only; the base model is never overwritten.

## Fixed experiment inputs

- Base model: `unsloth/Qwen3.5-4B`
- Training data: `../exp-001-sft-dataset/clean-v2/sft-clean-v2-800.csv`
  (800 balanced, deduplicated records; 200 per category)
